                ...
                <div class="inbox_msg">
                  <div class="inbox_people">
                    ...
                    <div class="inbox_chat">
                      <div class="chat_list"  v-for="(data, idx) in 20" :key="idx" v-bind:class="idx == 0 ? ' active_chat' : ''">
                        <div class="chat_people">
                          <div class="chat_img"> <img src="https://ptetutorials.com/images/user-profile.png" alt="sunil"> </div>
                          <div class="chat_ib">
                            <h5>Ryan Saputro {{data}} <span class="chat_date">{{data}} Des 2021</span></h5>
                  ...
                  <div class="mesgs">
                    ...
                    <div class="type_msg">
                      <div class="input_msg_write">
                        ...
                        <button class="msg_send_btn" type="button"><i class="now-ui-icons ui-1_send" aria-hidden="true"></i></button>
                      </div>
                    </div>
                  </div>
                </div>
